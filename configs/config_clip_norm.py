...
class config_mcdf_clip:
    ...
    clip_backbone_type = "ViT-L/14"
    # clip_backbone_path = "models/clip/VMamba_S_clip.pt"
    ...
    no_resize = False
    arch = "clip"
    wang2020_data_path = "/mnt/d/dataset/FD"
    ...
    if sch == 'StepLR':
        ...
        eta_min = 1e-8  # – Minimum learning rate. Default: 0.
        # last_epoch = -1 # – The index of last epoch. Default: -1.  
