...
class setting_config:
    ...
    test_root = "../../datasets/fdmas"  # if you don't write in config, you can set it here
    ...
    metric_mode = 'ap'
    latest_mode = 'ap'
    best_ckpt_path = 'results/vmunet_RealFake_Sunday_22_June_2025_14h_40m_40s/checkpoints/best_ap.pth'
