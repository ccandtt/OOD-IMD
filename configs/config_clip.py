...
class config_clip:
    ...
    clip_backbone_type = "CLIP_VMamba_B"  # 可选：CLIP_VMamba_S、CLIP_ResNet、CLIP_Swin 等
    clip_backbone_path = "models/clip/VMamba_B_clip.pt"
    backbone_embed_dim = CHANNELS[clip_backbone_type]  # 512 or 1024

    # # #############################  RealFake dataset configs
    data_label = "train"  # train or val
    data_mode = "wang2020"    # ours, wang2020, ours_wang2020
    isTrain = True
    cropSize = 224
    loadSize = [224, 224]
    no_flip = False
    ...
    no_resize = False
    arch = "clip"
    wang2020_data_path = "/home/wslct/RFNT/datasets/"
    test_root = "/home/wslct/RFNT/datasets/fdmas/AIGCDetect/AIGCDetect_testset/test/test"  # if you don't write in config, you can set it here
    ...
    criterion = nn.BCEWithLogitsLoss()   #PatchMiningLoss(criterion=torch.nn.BCEWithLogitsLoss())
    ...
    # work_dir = 'results/vmunet_UltraEdit_Saturday_21_June_2025_03h_34m_12s'
    print_interval = 20
    val_interval = 30
    save_interval = 10
    threshold = 0.5
    ...
    metric_mode = 'ap'
    latest_mode = 'ap'
    best_ckpt_path = '/home/wslct/VMunet-FF/home/orange/Location/VM-UNet/results/mamba_clip_RealFake_Tuesday_24_June_2025_22h_47m_52s/checkpoints/best_ap.pth'
